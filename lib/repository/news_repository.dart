...
class NewsRepository {
  ...
  Future<CategoriesNewsModel> fetchedCategoriesNewsApi({required String category}) async {
    String url =
        "https://newsapi.org/v2/everything?q=$category&apiKey=b7a147696a4a4aaabd7857b1e3650a67";
